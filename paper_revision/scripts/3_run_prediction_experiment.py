...
results_folder = os.path.abspath(os.path.join(root, "..", "results", "results_pairs_ev3"))
...
for sufix_0, sufix_1 in sufixes:
    ...
    print(model_name)
    model_folder = os.path.join(root, "..", "models", "models_pairs_ev3", model_name)
    n_folds = 0
