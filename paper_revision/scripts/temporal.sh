...
#python 2_run_training_experiment_misc.py --only_pk --only_adme_genes --miscl_perc 10
#python 2_run_training_experiment_misc.py --only_pk --miscl_perc 10
#python 2_run_training_experiment_misc.py --miscl_perc 10
...
python 2_run_training_experiment_misc.py --only_pk --only_adme_genes --miscl_perc 20
python 2_run_training_experiment_misc.py --only_pk --miscl_perc 20
python 2_run_training_experiment_misc.py --miscl_perc 20
...
python 2_run_training_experiment_misc.py --only_pk --only_adme_genes --miscl_perc 50
python 2_run_training_experiment_misc.py --only_pk --miscl_perc 50
python 2_run_training_experiment_misc.py --miscl_perc 50
